...
#ifndef DELTA_SMT_TEST_SPACE_ID
#define DELTA_SMT_TEST_SPACE_ID 13
#endif

enum smt_test_object_types
{
   smt_token_object_type = ( DELTA_SMT_TEST_SPACE_ID << 8 )
};
...
FC_REFLECT( delta::plugins::smt_test::smt_token_object,
   (id)
   (control_account)
   (decimal_places)
   (max_supply)
...
CHAINBASE_SET_INDEX_TYPE( delta::plugins::smt_test::smt_token_object, delta::plugins::smt_test::smt_token_index )
