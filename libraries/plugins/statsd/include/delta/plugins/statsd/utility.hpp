#pragma once
#include <delta/plugins/statsd/statsd_plugin.hpp>
...
using delta::plugins::statsd::statsd_plugin;
...
if( delta::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   delta::plugins::statsd::util::get_statsd().increment( \
...
if( delta::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   delta::plugins::statsd::util::get_statsd().decrement( \
      NAMESPACE, STAT, KEY, FREQ                         \
   );                                                    \
}
...
if( delta::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   delta::plugins::statsd::util::get_statsd().count(     \
...
if( delta::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   delta::plugins::statsd::util::get_statsd().gauge(     \
      NAMESPACE, STAT, KEY, VAL, FREQ                    \
   );                                                    \
}
...
fc::optional< delta::plugins::statsd::util::statsd_timer_helper > statsd_timer;  \
if( delta::plugins::statsd::util::statsd_enabled() )                             \
{                                                                                \
   statsd_timer = delta::plugins::statsd::util::statsd_timer_helper(             \
      NAMESPACE, STAT, KEY, FREQ, delta::plugins::statsd::util::get_statsd()     \
   );                                                                            \
}
...
if( delta::plugins::statsd::util::statsd_enabled() )     \
{                                                        \
   delta::plugins::statsd::util::get_statsd().timing(    \
      NAMESPACE, STAT, KEY,                              \
      delta::plugins::statsd::util::timing_helper( VAL ),\
      FREQ                                               \
   );                                                    \
}
