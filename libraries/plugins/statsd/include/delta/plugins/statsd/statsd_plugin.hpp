...
#define DELTA_STATSD_PLUGIN_NAME "statsd"

namespace delta { namespace plugins { namespace statsd {
...
class statsd_plugin : public appbase::plugin< statsd_plugin >
{
   public:
      ...
      static const std::string& name() { static std::string name = DELTA_STATSD_PLUGIN_NAME; return name; }
