#include <delta/plugins/debug_node_api/debug_node_api_plugin.hpp>
#include <delta/plugins/debug_node_api/debug_node_api.hpp>
...
{
   if( args.hardfork_id > DELTA_NUM_HARDFORKS )
      return {};
...
{
   JSON_RPC_REGISTER_API( DELTA_DEBUG_NODE_API_PLUGIN_NAME );
}
