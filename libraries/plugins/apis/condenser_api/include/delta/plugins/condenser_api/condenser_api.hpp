...
#include <delta/plugins/account_history_api/account_history_api.hpp>
#include <delta/plugins/account_by_key_api/account_by_key_api.hpp>
#include <delta/plugins/network_broadcast_api/network_broadcast_api.hpp>
#include <delta/plugins/tags_api/tags_api.hpp>
#include <delta/plugins/follow_api/follow_api.hpp>
#include <delta/plugins/reputation_api/reputation_api.hpp>
#include <delta/plugins/market_history_api/market_history_api.hpp>

#include <delta/plugins/condenser_api/condenser_api_legacy_objects.hpp>
...
struct api_account_object
{
   api_account_object( const database_api::api_account_object& a ) :
      ...
      reward_delta_balance( legacy_asset::from_asset( a.reward_delta_balance ) ),
      reward_vesting_balance( legacy_asset::from_asset( a.reward_vesting_balance ) ),
      reward_vesting_delta( legacy_asset::from_asset( a.reward_vesting_delta ) ),
   ...
   legacy_asset      reward_delta_balance;
   legacy_asset      reward_vesting_balance;
   legacy_asset      reward_vesting_delta;
...
struct extended_account : public api_account_object
{
   ...
   legacy_asset                                             vesting_balance;  /// convert vesting_shares to vesting delta
...
struct api_comment_object
{
   api_comment_object( const database_api::api_comment_object& c ):
      ...
      percent_delta_dollars( c.percent_delta_dollars ),
   ...
   uint16_t          percent_delta_dollars = 0;
...
struct extended_dynamic_global_properties
{
   ...
   extended_dynamic_global_properties( const database_api::api_dynamic_global_property_object& o ) :
      ...
      total_vesting_fund_delta( legacy_asset::from_asset( o.total_vesting_fund_delta ) ),
      total_vesting_shares( legacy_asset::from_asset( o.total_vesting_shares ) ),
      total_reward_fund_delta( legacy_asset::from_asset( o.total_reward_fund_delta ) ),
      ...
      pending_rewarded_vesting_delta( legacy_asset::from_asset( o.pending_rewarded_vesting_delta ) ),
   ...
   legacy_asset      total_vesting_fund_delta;
   legacy_asset      total_vesting_shares;
   legacy_asset      total_reward_fund_delta;
   fc::uint128       total_reward_shares2;
   legacy_asset      pending_rewarded_vesting_shares;
   legacy_asset      pending_rewarded_vesting_delta;
...
struct api_witness_object
{
   ...
   time_point_sec          hardfork_time_vote = DELTA_GENESIS_TIME;
...
struct api_witness_schedule_object
{
   ...
   uint8_t                       max_voted_witnesses           = DELTA_MAX_VOTED_WITNESSES_HF0;
   uint8_t                       max_miner_witnesses           = DELTA_MAX_MINER_WITNESSES_HF0;
   uint8_t                       max_runner_witnesses          = DELTA_MAX_RUNNER_WITNESSES_HF0;
   uint8_t                       hardfork_required_witnesses   = DELTA_HARDFORK_REQUIRED_WITNESSES;
...
struct api_escrow_object
{
   ...
   api_escrow_object( const database_api::api_escrow_object& e ) :
      ...
      delta_balance( legacy_asset::from_asset( e.delta_balance ) ),
...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v )
      :blockchain_version( bc_v ), delta_revision( s_v ), fc_revision( fc_v ) {}

   fc::string blockchain_version;
   fc::string delta_revision;
...
struct ticker
{
   ...
   ticker( const market_history::get_ticker_return& t ) :
      ...
      delta_volume( legacy_asset::from_asset( t.delta_volume ) ),
...
struct volume
{
   ...
   volume( const market_history::get_volume_return& v ) :
      delta_volume( legacy_asset::from_asset( v.delta_volume ) ),
...
FC_REFLECT( delta::plugins::condenser_api::discussion_index,
...
FC_REFLECT( delta::plugins::condenser_api::api_account_object,
             ...
             (reward_dbd_balance)(reward_delta_balance)(reward_vesting_balance)(reward_vesting_delta)
...
FC_REFLECT_DERIVED( delta::plugins::condenser_api::extended_account, (delta::plugins::condenser_api::api_account_object),
...
FC_REFLECT( delta::plugins::condenser_api::api_comment_object,
             (id)(author)(permlink)
             ...
             (max_accepted_payout)(percent_delta_dollars)(allow_replies)(allow_votes)(allow_curation_rewards)
             (beneficiaries)
          )

FC_REFLECT( delta::plugins::condenser_api::extended_dynamic_global_properties,
            (head_block_number)(head_block_id)(time)
            (current_witness)(total_pow)(num_pow_witnesses)
            (virtual_supply)(current_supply)(confidential_supply)(current_dbd_supply)(confidential_dbd_supply)
            (total_vesting_fund_delta)(total_vesting_shares)
            (total_reward_fund_delta)(total_reward_shares2)(pending_rewarded_vesting_shares)(pending_rewarded_vesting_delta)
...
FC_REFLECT( delta::plugins::condenser_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( delta::plugins::condenser_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT( delta::plugins::condenser_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( delta::plugins::condenser_api::api_reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
FC_REFLECT( delta::plugins::condenser_api::api_escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (dbd_balance)(delta_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )

FC_REFLECT( delta::plugins::condenser_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( delta::plugins::condenser_api::api_vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )

FC_REFLECT( delta::plugins::condenser_api::api_vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )

FC_REFLECT( delta::plugins::condenser_api::api_convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )

FC_REFLECT_DERIVED( delta::plugins::condenser_api::discussion, (delta::plugins::condenser_api::api_comment_object),
...
FC_REFLECT( delta::plugins::condenser_api::scheduled_hardfork,
            (hf_version)(live_time) )

FC_REFLECT( delta::plugins::condenser_api::account_vote,
            (authorperm)(weight)(rshares)(percent)(time) )

FC_REFLECT( delta::plugins::condenser_api::tag_index, (trending) )

FC_REFLECT_ENUM( delta::plugins::condenser_api::withdraw_route_type, (incoming)(outgoing)(all) )

FC_REFLECT( delta::plugins::condenser_api::get_version_return,
            (blockchain_version)(delta_revision)(fc_revision) )

FC_REFLECT( delta::plugins::condenser_api::broadcast_transaction_synchronous_return,
            (id)(block_num)(trx_num)(expired) )

FC_REFLECT( delta::plugins::condenser_api::comment_feed_entry,
            (comment)(reblog_by)(reblog_on)(entry_id) )

FC_REFLECT( delta::plugins::condenser_api::comment_blog_entry,
            (comment)(blog)(reblog_on)(entry_id) )

FC_REFLECT( delta::plugins::condenser_api::ticker,
            (latest)(lowest_ask)(highest_bid)(percent_change)(delta_volume)(dbd_volume) )

FC_REFLECT( delta::plugins::condenser_api::volume,
            (delta_volume)(dbd_volume) )

FC_REFLECT( delta::plugins::condenser_api::order,
            (order_price)(real_price)(delta)(dbd)(created) )

FC_REFLECT( delta::plugins::condenser_api::order_book,
            (bids)(asks) )

FC_REFLECT( delta::plugins::condenser_api::market_trade,
