#include <delta/plugins/rc_api/rc_api_plugin.hpp>
#include <delta/plugins/rc_api/rc_api.hpp>

#include <delta/plugins/rc/rc_objects.hpp>
#include <delta/plugins/rc/resource_sizes.hpp>
...
{
   public:
      rc_api_impl() : _db( appbase::app().get_plugin< delta::plugins::chain::chain_plugin >().db() ) {}
...
{
   JSON_RPC_REGISTER_API( DELTA_RC_API_PLUGIN_NAME );
}
