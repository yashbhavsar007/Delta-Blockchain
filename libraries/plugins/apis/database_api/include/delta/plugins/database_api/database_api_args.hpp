...
struct get_version_return
{
   ...
   get_version_return( fc::string bc_v, fc::string s_v, fc::string fc_v, chain_id_type c_id )
      :blockchain_version( bc_v ), delta_revision( s_v ), fc_revision( fc_v ), chain_id( c_id ) {}
...
struct list_dbd_conversion_requests_args
{
   fc::variant       start;
   uint32_t          limit;
   sort_order_type   order;
...
FC_REFLECT( delta::plugins::database_api::get_version_return,
            (blockchain_version)(delta_revision)(fc_revision)(chain_id) )

FC_REFLECT_ENUM( delta::plugins::database_api::sort_order_type,
   (by_name)
   (by_proxy)
   (by_next_vesting_withdrawal)
   (by_account)
...
FC_REFLECT( delta::plugins::database_api::get_reward_funds_return,
   (funds) )

FC_REFLECT( delta::plugins::database_api::list_witnesses_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_witnesses_return,
   (witnesses) )

FC_REFLECT( delta::plugins::database_api::find_witnesses_args,
   (owners) )

FC_REFLECT( delta::plugins::database_api::list_witness_votes_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_witness_votes_return,
   (votes) )

FC_REFLECT( delta::plugins::database_api::get_active_witnesses_return,
   (witnesses) )

FC_REFLECT( delta::plugins::database_api::list_accounts_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_accounts_return,
   (accounts) )

FC_REFLECT( delta::plugins::database_api::find_accounts_args,
   (accounts) )

FC_REFLECT( delta::plugins::database_api::list_owner_histories_args,
   (start)(limit) )

FC_REFLECT( delta::plugins::database_api::list_owner_histories_return,
   (owner_auths) )

FC_REFLECT( delta::plugins::database_api::find_owner_histories_args,
   (owner) )

FC_REFLECT( delta::plugins::database_api::list_account_recovery_requests_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_account_recovery_requests_return,
   (requests) )

FC_REFLECT( delta::plugins::database_api::find_account_recovery_requests_args,
   (accounts) )

FC_REFLECT( delta::plugins::database_api::list_change_recovery_account_requests_args,
   (start)(limit)(order) )

FC_REFLECT(
   delta::plugins::database_api::list_change_recovery_account_requests_return,
   (requests) )

FC_REFLECT( delta::plugins::database_api::find_change_recovery_account_requests_args,
   (accounts) )

FC_REFLECT( delta::plugins::database_api::list_escrows_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_escrows_return,
   (escrows) )

FC_REFLECT( delta::plugins::database_api::find_escrows_args,
   (from) )

FC_REFLECT( delta::plugins::database_api::list_withdraw_vesting_routes_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_withdraw_vesting_routes_return,
   (routes) )

FC_REFLECT( delta::plugins::database_api::find_withdraw_vesting_routes_args,
   (account)(order) )

FC_REFLECT( delta::plugins::database_api::list_savings_withdrawals_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_savings_withdrawals_return,
   (withdrawals) )

FC_REFLECT( delta::plugins::database_api::find_savings_withdrawals_args,
   (account) )

FC_REFLECT( delta::plugins::database_api::list_vesting_delegations_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_vesting_delegations_return,
   (delegations) )

FC_REFLECT( delta::plugins::database_api::find_vesting_delegations_args,
   (account) )

FC_REFLECT( delta::plugins::database_api::list_vesting_delegation_expirations_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_vesting_delegation_expirations_return,
   (delegations) )

FC_REFLECT( delta::plugins::database_api::find_vesting_delegation_expirations_args,
   (account) )

FC_REFLECT( delta::plugins::database_api::list_dbd_conversion_requests_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_dbd_conversion_requests_return,
   (requests) )

FC_REFLECT( delta::plugins::database_api::find_dbd_conversion_requests_args,
   (account) )

FC_REFLECT( delta::plugins::database_api::list_decline_voting_rights_requests_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_decline_voting_rights_requests_return,
   (requests) )

FC_REFLECT( delta::plugins::database_api::find_decline_voting_rights_requests_args,
   (accounts) )

FC_REFLECT( delta::plugins::database_api::list_comments_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_comments_return,
   (comments) )

FC_REFLECT( delta::plugins::database_api::find_comments_args,
   (comments) )

FC_REFLECT( delta::plugins::database_api::list_votes_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_votes_return,
   (votes) )

FC_REFLECT( delta::plugins::database_api::find_votes_args,
   (author)(permlink) )

FC_REFLECT( delta::plugins::database_api::list_limit_orders_args,
   (start)(limit)(order) )

FC_REFLECT( delta::plugins::database_api::list_limit_orders_return,
   (orders) )

FC_REFLECT( delta::plugins::database_api::find_limit_orders_args,
   (account) )

FC_REFLECT( delta::plugins::database_api::get_order_book_args,
   (limit) )

FC_REFLECT( delta::plugins::database_api::get_transaction_hex_args,
   (trx) )

FC_REFLECT( delta::plugins::database_api::get_transaction_hex_return,
   (hex) )

FC_REFLECT( delta::plugins::database_api::get_required_signatures_args,
   (trx)
   (available_keys) )

FC_REFLECT( delta::plugins::database_api::get_required_signatures_return,
   (keys) )

FC_REFLECT( delta::plugins::database_api::get_potential_signatures_args,
   (trx) )

FC_REFLECT( delta::plugins::database_api::verify_authority_args,
   (trx) )

FC_REFLECT( delta::plugins::database_api::verify_authority_return,
   (valid) )

FC_REFLECT( delta::plugins::database_api::verify_account_authority_args,
   (account)
   (signers) )

FC_REFLECT( delta::plugins::database_api::verify_signatures_args,
   (hash)
   (signatures)
   (required_owner)
   (required_active)
...
FC_REFLECT( delta::plugins::database_api::verify_signatures_return,
   (valid) )

#ifdef DELTA_ENABLE_SMT
FC_REFLECT( delta::plugins::database_api::get_smt_next_identifier_return,
   (nais) )
#endif
