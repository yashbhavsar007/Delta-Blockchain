...
struct api_comment_object
{
   api_comment_object( const comment_object& o, const database& db ):
      ...
      percent_delta_dollars( o.percent_delta_dollars ),
...
struct api_account_object
{
   api_account_object( const account_object& a, const database& db ) :
      ...
      reward_delta_balance( a.reward_delta_balance ),
      reward_vesting_balance( a.reward_vesting_balance ),
      reward_vesting_delta( a.reward_vesting_delta ),
   ...
   asset             reward_delta_balance;
   asset             reward_vesting_balance;
   asset             reward_vesting_delta;
...
{
   price                order_price;
   double               real_price; // dollars per delta
   share_type           delta;
   share_type           dbd;
...
FC_REFLECT( delta::plugins::database_api::api_comment_object,
             (id)(author)(permlink)
...
FC_REFLECT( delta::plugins::database_api::api_comment_vote_object,
             (id)(voter)(author)(permlink)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )

FC_REFLECT( delta::plugins::database_api::api_account_object,
...
FC_REFLECT( delta::plugins::database_api::api_owner_authority_history_object,
             (id)
             (account)
...
FC_REFLECT( delta::plugins::database_api::api_account_recovery_request_object,
             (id)
             (account_to_recover)
             (new_owner_authority)
             (expires)
...
FC_REFLECT( delta::plugins::database_api::api_savings_withdraw_object,
             (id)
             (from)
             (to)
             (memo)
...
FC_REFLECT( delta::plugins::database_api::api_feed_history_object,
             (id)
             (current_median_history)
             (price_history)
          )

FC_REFLECT( delta::plugins::database_api::api_witness_object,
             (id)
             (owner)
             (created)
...
FC_REFLECT( delta::plugins::database_api::api_witness_schedule_object,
             (id)
...
FC_REFLECT_DERIVED( delta::plugins::database_api::api_signed_block_object, (delta::protocol::signed_block),
                     (block_id)
                     (signing_key)
                     (transaction_ids)
                  )

FC_REFLECT( delta::plugins::database_api::api_hardfork_property_object,
            (id)
            (processed_hardforks)
            (last_hardfork)
...
FC_REFLECT( delta::plugins::database_api::order, (order_price)(real_price)(delta)(dbd)(created) );

FC_REFLECT( delta::plugins::database_api::order_book, (asks)(bids) );
