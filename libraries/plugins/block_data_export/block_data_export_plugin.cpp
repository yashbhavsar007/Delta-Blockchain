...
namespace delta { namespace plugins { namespace block_data_export {
...
FC_REFLECT( delta::plugins::block_data_export::detail::api_export_data_object, (block_id)(previous)(export_data) )

namespace delta { namespace plugins { namespace block_data_export { namespace detail {
...
} } } // delta::plugins::block_data_export
