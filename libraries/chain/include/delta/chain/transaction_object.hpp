...
FC_REFLECT( delta::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::transaction_object, delta::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<delta::chain::transaction_index>
   {
   public:
      typedef delta::chain::transaction_index IndexType;
      typedef typename delta::chain::transaction_object::t_packed_trx t_packed_trx;
