...
#ifdef DELTA_ENABLE_SMT
FC_REFLECT( delta::chain::comment_object,
             (id)(author)(permlink)
...
#endif
CHAINBASE_SET_INDEX_TYPE( delta::chain::comment_object, delta::chain::comment_index )

FC_REFLECT( delta::chain::comment_content_object,
            (id)(comment)(title)(body)(json_metadata) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::comment_content_object, delta::chain::comment_content_index )

FC_REFLECT( delta::chain::comment_vote_object,
             (id)(voter)(comment)(weight)(rshares)(vote_percent)(last_update)(num_changes)
          )
CHAINBASE_SET_INDEX_TYPE( delta::chain::comment_vote_object, delta::chain::comment_vote_index )

namespace helpers
{
   using delta::chain::shared_string;
   
   template <>
   class index_statistic_provider<delta::chain::comment_index>
   {
   public:
      typedef delta::chain::comment_index IndexType;
      typedef typename delta::chain::comment_object::t_beneficiaries t_beneficiaries;
#ifdef DELTA_ENABLE_SMT
      typedef typename delta::chain::comment_object::t_votable_assets t_votable_assets;
#endif
   ...
   template <>
   class index_statistic_provider<delta::chain::comment_content_index>
   {
   public:
      typedef delta::chain::comment_content_index IndexType;
