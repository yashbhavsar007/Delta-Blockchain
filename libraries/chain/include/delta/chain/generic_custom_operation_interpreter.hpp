...
#include <delta/protocol/schema_types.hpp>
#include <delta/chain/schema_types.hpp>
   ...
   : public custom_operation_interpreter, public evaluator_registry< CustomOperationType >
{
   public:
      ...
      virtual std::shared_ptr< delta::schema::abstract_schema > get_operation_schema() override
      {
         return delta::schema::get_schema_for_type< CustomOperationType >();
      }
};
