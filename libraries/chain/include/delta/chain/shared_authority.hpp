...
namespace delta { namespace chain {
   ...
   using delta::protocol::weight_type;
...
FC_REFLECT_TYPENAME( delta::chain::shared_authority::account_authority_map)
FC_REFLECT( delta::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
