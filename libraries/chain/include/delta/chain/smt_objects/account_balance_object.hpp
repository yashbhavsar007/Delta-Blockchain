...
public:   
   ...
   asset               liquid;   /// 'balance' for DELTA
...
public:   
   ...
   /// Name of the account, the balance is held for.
   account_name_type   owner;
   asset               pending_liquid;          /// 'reward_delta_balance' for pending DELTA
   asset               pending_vesting_shares;  /// 'reward_vesting_balance' for pending VESTS
   asset               pending_vesting_value;   /// 'reward_vesting_delta' for pending VESTS
...
FC_REFLECT( delta::chain::account_regular_balance_object,
   (id)
   (owner)
   (liquid)
   (vesting)
...
FC_REFLECT( delta::chain::account_rewards_balance_object,
   (id)
   (owner)
   (pending_liquid)
...
CHAINBASE_SET_INDEX_TYPE( delta::chain::account_regular_balance_object, delta::chain::account_regular_balance_index )
CHAINBASE_SET_INDEX_TYPE( delta::chain::account_rewards_balance_object, delta::chain::account_rewards_balance_index )
