...
#include <delta/chain/util/rd_dynamics.hpp>
...
namespace delta { namespace chain {
   ...
   using delta::protocol::digest_type;
   using delta::protocol::public_key_type;
   using delta::protocol::version;
   using delta::protocol::hardfork_version;
   using delta::protocol::price;
   using delta::protocol::asset;
   using delta::protocol::asset_symbol_type;
   using delta::chain::util::rd_dynamics_params;
   ...
   struct chain_properties
   {
      ...
      asset             account_creation_fee =
         asset( DELTA_MIN_ACCOUNT_CREATION_FEE, DELTA_SYMBOL );
       ...
       * Scaled so that DELTA_ACCOUNT_SUBSIDY_PRECISION represents one account.
       */
       ...
       * Scaled so that 1 << DELTA_RD_DECAY_DENOM_SHIFT represents 100% of accounts
       * expiring.
       */
   ...
   class witness_object : public object< witness_object_type, witness_object >
   {
      ...
      public:
         ...
         /**
          * This field represents the Delta blockchain version the witness is running.
          */
   ...
   class witness_schedule_object : public object< witness_schedule_object_type, witness_schedule_object >
   {
      public:
         ...
         fc::array< account_name_type, DELTA_MAX_WITNESSES >             current_shuffled_witnesses;
...
FC_REFLECT_ENUM( delta::chain::witness_object::witness_schedule_type, (elected)(timeshare)(miner)(none) )

FC_REFLECT( delta::chain::chain_properties,
...
FC_REFLECT( delta::chain::witness_object,
             (id)
             (owner)
             (created)
...
CHAINBASE_SET_INDEX_TYPE( delta::chain::witness_object, delta::chain::witness_index )

FC_REFLECT( delta::chain::witness_vote_object, (id)(witness)(account) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::witness_vote_object, delta::chain::witness_vote_index )

FC_REFLECT( delta::chain::witness_schedule_object,
...
CHAINBASE_SET_INDEX_TYPE( delta::chain::witness_schedule_object, delta::chain::witness_schedule_index )
