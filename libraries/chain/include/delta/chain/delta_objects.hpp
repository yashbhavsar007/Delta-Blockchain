...
namespace delta { namespace chain {
   ...
   /**
    *  This object is used to track pending requests to convert dbd to delta
    */
    ...
    *  1000 DELTA or 1000 * virtual_supply / (100*blocks_per_year) aka 10 * virtual_supply / blocks_per_year
    *
   ...
   class liquidity_reward_balance_object : public object< liquidity_reward_balance_object_type, liquidity_reward_balance_object >
   {
      public:
         ...
         {
            return delta_volume * dbd_volume * is_positive();
         }

         uint128_t min_volume_weight()const
         {
            return std::min(delta_volume,dbd_volume) * is_positive();
         }
         ...
         {
            return ( delta_volume > 0 && dbd_volume > 0 ) ? 1 : 0;
         }
   };
...
FC_REFLECT( delta::chain::limit_order_object,
             (id)(created)(expiration)(seller)(orderid)(for_sale)(sell_price) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::limit_order_object, delta::chain::limit_order_index )

FC_REFLECT( delta::chain::feed_history_object,
             (id)(current_median_history)(price_history) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::feed_history_object, delta::chain::feed_history_index )

FC_REFLECT( delta::chain::convert_request_object,
             (id)(owner)(requestid)(amount)(conversion_date) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::convert_request_object, delta::chain::convert_request_index )

FC_REFLECT( delta::chain::liquidity_reward_balance_object,
             (id)(owner)(delta_volume)(dbd_volume)(weight)(last_update) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::liquidity_reward_balance_object, delta::chain::liquidity_reward_balance_index )

FC_REFLECT( delta::chain::withdraw_vesting_route_object,
             (id)(from_account)(to_account)(percent)(auto_vest) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::withdraw_vesting_route_object, delta::chain::withdraw_vesting_route_index )

FC_REFLECT( delta::chain::savings_withdraw_object,
             (id)(from)(to)(memo)(request_id)(amount)(complete) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::savings_withdraw_object, delta::chain::savings_withdraw_index )

FC_REFLECT( delta::chain::escrow_object,
             (id)(escrow_id)(from)(to)(agent)
             (ratification_deadline)(escrow_expiration)
             (dbd_balance)(delta_balance)(pending_fee)
             (to_approved)(agent_approved)(disputed) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::escrow_object, delta::chain::escrow_index )

FC_REFLECT( delta::chain::decline_voting_rights_request_object,
             (id)(account)(effective_date) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::decline_voting_rights_request_object, delta::chain::decline_voting_rights_request_index )

FC_REFLECT( delta::chain::reward_fund_object,
            (id)
            (name)
            (reward_balance)
            (recent_claims)
...
CHAINBASE_SET_INDEX_TYPE( delta::chain::reward_fund_object, delta::chain::reward_fund_index )
