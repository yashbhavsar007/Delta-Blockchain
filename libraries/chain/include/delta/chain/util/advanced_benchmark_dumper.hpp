...
FC_REFLECT( delta::chain::util::advanced_benchmark_dumper::item, (op_name)(time) )
FC_REFLECT( delta::chain::util::advanced_benchmark_dumper::ritem, (op_name)(time) )

FC_REFLECT( delta::chain::util::advanced_benchmark_dumper::total_info< std::set< delta::chain::util::advanced_benchmark_dumper::item > >, (total_time)(items) )
FC_REFLECT( delta::chain::util::advanced_benchmark_dumper::total_info< std::multiset< delta::chain::util::advanced_benchmark_dumper::ritem > >, (total_time)(items) )
