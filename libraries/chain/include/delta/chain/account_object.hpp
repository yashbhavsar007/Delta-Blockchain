...
#include <delta/protocol/authority.hpp>
...
#include <delta/chain/shared_authority.hpp>
...
namespace delta { namespace chain {
   ...
   using delta::protocol::authority;
   ...
   class account_object : public object< account_object_type, account_object >
   {
      ...
      public:
         ...
         account_name_type reset_account = DELTA_NULL_ACCOUNT;
         ...
         asset             balance = asset( 0, DELTA_SYMBOL );  ///< total liquid shares held by this account
         asset             savings_balance = asset( 0, DELTA_SYMBOL );  ///< total liquid shares held by this account
          ...
          *  DELTA_MIN_COMPOUNDING_INTERVAL_SECONDS has past since dbd_last_interest_payment then
         ...
         asset             reward_delta_balance = asset( 0, DELTA_SYMBOL );
         asset             reward_vesting_balance = asset( 0, VESTS_SYMBOL );
         asset             reward_vesting_delta = asset( 0, DELTA_SYMBOL );
         ...
         fc::array<share_type, DELTA_MAX_PROXY_RECURSION_DEPTH> proxied_vsf_votes;// = std::vector<share_type>( DELTA_MAX_PROXY_RECURSION_DEPTH, 0 ); ///< the total VFS votes proxied to this account
...
FC_REFLECT( delta::chain::account_object,
             ...
             (reward_delta_balance)(reward_dbd_balance)(reward_vesting_balance)(reward_vesting_delta)
...
CHAINBASE_SET_INDEX_TYPE( delta::chain::account_object, delta::chain::account_index )

FC_REFLECT( delta::chain::account_authority_object,
             (id)(account)(owner)(active)(posting)(last_owner_update)
)
CHAINBASE_SET_INDEX_TYPE( delta::chain::account_authority_object, delta::chain::account_authority_index )

FC_REFLECT( delta::chain::vesting_delegation_object,
            (id)(delegator)(delegatee)(vesting_shares)(min_delegation_time) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::vesting_delegation_object, delta::chain::vesting_delegation_index )

FC_REFLECT( delta::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( delta::chain::vesting_delegation_expiration_object, delta::chain::vesting_delegation_expiration_index )

FC_REFLECT( delta::chain::owner_authority_history_object,
             (id)(account)(previous_owner_authority)(last_valid_time)
          )
CHAINBASE_SET_INDEX_TYPE( delta::chain::owner_authority_history_object, delta::chain::owner_authority_history_index )

FC_REFLECT( delta::chain::account_recovery_request_object,
             (id)(account_to_recover)(new_owner_authority)(expires)
          )
CHAINBASE_SET_INDEX_TYPE( delta::chain::account_recovery_request_object, delta::chain::account_recovery_request_index )

FC_REFLECT( delta::chain::change_recovery_account_request_object,
             (id)(account_to_recover)(recovery_account)(effective_on)
          )
CHAINBASE_SET_INDEX_TYPE( delta::chain::change_recovery_account_request_object, delta::chain::change_recovery_account_request_index )
