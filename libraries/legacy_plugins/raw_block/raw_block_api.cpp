...
{
   public:
      raw_block_api_impl( delta::app::application& _app );

      std::shared_ptr< delta::plugin::raw_block::raw_block_plugin > get_plugin();

      delta::app::application& app;
};

raw_block_api_impl::raw_block_api_impl( delta::app::application& _app ) : app( _app )
{}

std::shared_ptr< delta::plugin::raw_block::raw_block_plugin > raw_block_api_impl::get_plugin()
{
...
raw_block_api::raw_block_api( const delta::app::api_context& ctx )
{
...
get_raw_block_result raw_block_api::get_raw_block( get_raw_block_args args )
{
   ...
   std::shared_ptr< delta::chain::database > db = my->app.chain_database();
