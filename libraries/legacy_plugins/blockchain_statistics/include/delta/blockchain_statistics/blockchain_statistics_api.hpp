...
#include <delta/blockchain_statistics/blockchain_statistics_plugin.hpp>
...
{
   public:
      blockchain_statistics_api( const delta::app::api_context& ctx );
...
FC_REFLECT( delta::blockchain_statistics::statistics,
   (blocks)
   (bandwidth)
   (operations)
   (transactions)
...
FC_API( delta::blockchain_statistics::blockchain_statistics_api,
   (get_stats_for_time)
