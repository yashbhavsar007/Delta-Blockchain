...
#define DELTA_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )  \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
DELTA_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )              \
};

// Templated version of macro includes some method definitions
#define DELTA_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )        \
...
#define DELTA_SCHEMA_CLASS_BODY( CLASSNAME )                 \
...
#define DELTA_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )       \
...
DELTA_DECLARE_SCHEMA_CLASS( false, false )
DELTA_DECLARE_SCHEMA_CLASS(  true, false )
DELTA_DECLARE_SCHEMA_CLASS(  true,  true )
