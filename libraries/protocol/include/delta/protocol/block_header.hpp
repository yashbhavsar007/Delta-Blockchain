...
#include <delta/protocol/optional_automated_actions.hpp>
...
FC_REFLECT_TYPENAME( delta::protocol::block_header_extensions )

FC_REFLECT( delta::protocol::block_header, (previous)(timestamp)(witness)(transaction_merkle_root)(extensions) )
FC_REFLECT_DERIVED( delta::protocol::signed_block_header, (delta::protocol::block_header), (witness_signature) )
