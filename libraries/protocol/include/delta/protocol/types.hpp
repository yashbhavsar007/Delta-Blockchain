...
#include <delta/protocol/fixed_string.hpp>
...
namespace delta {
   ...
   namespace protocol {
      ...
      #define DELTA_INIT_PUBLIC_KEY (delta::protocol::public_key_type(DELTA_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const delta::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  delta::protocol::public_key_type& vo );
    void to_variant( const delta::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, delta::protocol::extended_public_key_type& vo );
    void to_variant( const delta::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, delta::protocol::extended_private_key_type& vo );
}

FC_REFLECT( delta::protocol::public_key_type, (key_data) )
FC_REFLECT( delta::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( delta::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( delta::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( delta::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( delta::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( delta::protocol::share_type )

FC_REFLECT( delta::void_t, )
