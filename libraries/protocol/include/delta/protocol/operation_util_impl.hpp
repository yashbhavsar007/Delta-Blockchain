...
//
// Place DELTA_DEFINE_OPERATION_TYPE in a .cpp file to define
// functions related to your operation type
//
#define DELTA_DEFINE_OPERATION_TYPE( OperationType )                       \
                                                                           \
namespace delta { namespace protocol {                                     \
                                                                           \
void operation_validate( const OperationType& op )                         \
{                                                                          \
   op.visit( delta::protocol::operation_validate_visitor() );              \
}                                                                          \
                                                                           \
...
{                                                                          \
   op.visit( delta::protocol::get_required_auth_visitor( active, owner, posting, other ) ); \
}                                                                          \
                                                                           \
} } /* delta::protocol */
