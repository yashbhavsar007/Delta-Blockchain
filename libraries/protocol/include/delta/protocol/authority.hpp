 ...
 * - Length is between (inclusive) DELTA_MIN_ACCOUNT_NAME_LENGTH and DELTA_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace delta::protocol


FC_REFLECT_TYPENAME( delta::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( delta::protocol::authority::key_authority_map)
FC_REFLECT( delta::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( delta::protocol::authority::classification, (owner)(active)(key)(posting) )
