...
using fc::ecc::canonical_signature_type;
   ...
   struct signed_transaction : public transaction
   {
      ...
      set<public_key_type> get_required_signatures(
         ...
         uint32_t max_recursion = DELTA_MAX_SIG_CHECK_DEPTH,
         uint32_t max_membership = DELTA_MAX_AUTHORITY_MEMBERSHIP,
         uint32_t max_account_auths = DELTA_MAX_SIG_CHECK_ACCOUNTS,
...
FC_REFLECT( delta::protocol::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( delta::protocol::signed_transaction, (delta::protocol::transaction), (signatures) )
FC_REFLECT_DERIVED( delta::protocol::annotated_signed_transaction, (delta::protocol::signed_transaction), (transaction_id)(block_num)(transaction_num) );
