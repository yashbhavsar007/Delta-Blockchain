...
# local imports
from deltadebugnode import DebugNode
...
def main( ):
   ...
   parser = ArgumentParser( description='Run a deltad debug node on an existing chain, trigger a hardfork' \
...
def run_deltad_tests( debug_node ):
   from deltaapi.deltanoderpc import DeltaNodeRPC
   ...
   try:
      ...
      rpc = DeltaNodeRPC( 'ws://127.0.0.1:8095', '', '' )
