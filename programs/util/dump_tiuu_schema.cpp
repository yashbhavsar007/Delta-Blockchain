...
#include <delta/schema/schema.hpp>
#include <delta/schema/schema_impl.hpp>
#include <delta/schema/schema_types.hpp>

#include <delta/chain/schema_types/oid.hpp>
#include <delta/protocol/schema_types/account_name_type.hpp>
#include <delta/protocol/schema_types/asset_symbol_type.hpp>
...
using delta::schema::abstract_schema;
...
FC_REFLECT( delta_schema, (schema_map)(chain_object_types) )

int main( int argc, char** argv, char** envp )
{
   delta::chain::database db;
   delta::chain::database::open_args db_args;
   ...
   db.for_each_index_extension< delta::chain::index_info >(
      [&]( std::shared_ptr< delta::chain::index_info > info )
      {
         std::string name;
