...
operation_tests      // Unit Tests of Delta operations
operation_time_tests // Tests of Delta operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_DELTA_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
